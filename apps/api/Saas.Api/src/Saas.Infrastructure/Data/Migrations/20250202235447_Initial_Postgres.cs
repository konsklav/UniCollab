        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug = table.Column<string>(type: "varchar(55)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostSubject", x => new { x.PostId, x.SubjectsId });
                    table.ForeignKey(
                        name: "FK_PostSubject_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostSubject_SubjectsId",
                table: "PostSubject",
                column: "SubjectsId");
